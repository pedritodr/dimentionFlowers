<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= translate('add_nosotro_lang'); ?></li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('add_nosotro_lang'); ?></h3>
                    </div>
                    <div class="box-body">

                        <?= get_message_from_operation(); ?>

                        <?= form_open_multipart("sobre_nosotros/add"); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-image"></i></span>
                                            <input type="file" class="form-control" name="icon" required placeholder="<?= translate('image_lang'); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc_corta" class="form-control textarea" placeholder="<?= translate('descripcion_corta_lang'); ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="control-label"><?= translate('add_descripcion_lang'); ?> </label>
                                            <textarea name="desc" class="form-control textarea" placeholder="<?= translate('add_descripcion_lang'); ?>"></textarea>
                                        </div>
                                    </div>
