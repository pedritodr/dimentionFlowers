                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="name" required placeholder="<?= translate('fullname_lang'); ?>" value="<?= $client_object->cliente_name; ?>">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="cod_facturacion" placeholder="<?= translate('cod_facturacion_lang'); ?>" value="<?= $client_object->cod_facturacion; ?>">
                                    ...
                                    <div class=" col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="identificador" placeholder="<?= translate('tax_lang'); ?>" value="<?= $client_object->tax_id; ?>">
                                            <?php } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="address" placeholder="<?= translate('direccion_lang'); ?>" value="<?= $client_object->address; ?>">
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="phone" placeholder="<?= translate('phone_lang'); ?>" value="<?= $client_object->phone; ?>">
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="person_contact" placeholder="<?= translate('person_contac_lang'); ?>" value="<?= $client_object->contact_person; ?>">
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="email" class="form-control input-sm" name="email_contact" placeholder="<?= translate('email_lang') ?>" value="<?= $client_object->contact_email; ?>">
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="skype_contact" placeholder="<?= translate('skype_person_contact_lang'); ?>" value="<?= $client_object->skype_contact; ?>">
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="phone_contact" placeholder="<?= translate('phone_person_contact_lang'); ?>" value="<?= $client_object->phone_contact; ?>">
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="person_pago" placeholder="<?= translate('person_pago_lang'); ?>" value="<?= $client_object->paid_person; ?>">
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="email" class="form-control input-sm" name="email_pago" placeholder="<?= translate('email_pago_lang') ?>" value="<?= $client_object->paid_email; ?>">
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="skype_person" placeholder="<?= translate('skype_person_pago_lang'); ?>" value="<?= $client_object->skype_person; ?>">
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="phone_person" placeholder="<?= translate('phone_person_pago_lang'); ?>" value="<?= $client_object->phone_person; ?>">
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="pais" name="pais" class="form-control input-sm" data-placeholder="Seleccione una opción" style="width: 100%">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php } else { ?>
                                                <input type="text" class="form-control input-sm" name="secuencial" placeholder="<?= translate('secuencial_lang'); ?>" value="<?= $client_object->secuencial; ?>">
                                            <?php }  ?>
                                        </div>
                                    </div>
                                </div>
