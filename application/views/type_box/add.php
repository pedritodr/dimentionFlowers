...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('add_type_box_lang'); ?></small>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= translate('add_type_box_lang'); ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('add_type_box_lang'); ?></h3>
                    </div>
                    <div class="box-body">

                        <?= get_message_from_operation(); ?>

                        <?= form_open_multipart("type_box/add"); ?>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control input-sm" name="max" min="1" pattern="^[0-9]+" placeholder="<?= translate('max_item_lang'); ?>">
                                    </div>
                                </div>
