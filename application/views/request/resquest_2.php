...
<script>
    ...
    window.onload = function() {
        ...
        $('.btn-add').click((e) => {
            ...
            if ($("select[name=variety]").val() == 0) {
                ...
                addToCart(category, box_name, destino, request_product_id, product_id, producto, measure_id, measure, marcacion, type_box, cantidad_box, price_unit, qty_bunches, stems_bunch, photo, destino_id, carguera_id, sub_total, total_bunches, 2, 0)
    ...
    function addToCart(category, box_name, destino, request_product_id, product_id, producto, measure_id, measure, marcacion, type_box, cantidad_box, price_unit, qty_bunches, stems_bunch, photo, destino_id, carguera_id, sub_total, total_steams, estatus, carga) {
    ...
    function deleteItem(e) {
        ...
        let cantidad = $(e.parentElement).attr('cantidad');
