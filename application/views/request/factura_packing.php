                                    ...
                                    <tr>
                                        ...
                                        <?php if ($item->product_category_id  == 4 || $item->product_category_id  == 5 || $item->product_category_id  == 27 || $item->product_category_id  == 31 || $item->product_category_id  == 10 || $item->product_category_id  == 25) { ?>
                                            ...
                                            <?php if (($item->product_category_id == 31 && ($cliente->cliente_id == 6)) || ($item->product_category_id == 31 && ($cliente->cliente_id == 12))) { ?>
                                                <?php $total = number_format($element->nro_bunches * $element->price_finca * $box->nro_cajas, 2) ?>
                                            <?php } else { ?>
                                                <?php if ($cliente->cliente_id != 5) { ?>
                                                    <?php if ($item->product_category_id == 25) { ?>
                                                        <?php $total = number_format($element->nro_bunches * $element->price_finca * $box->nro_cajas, 2) ?>
                                                    <?php } else { ?>
                                                        <?php $total = number_format($box->nro_cajas * $element->stems_bunch * $element->nro_bunches * $element->price_finca, 2) ?>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <?php $total = number_format($element->nro_bunches * $element->price_finca * $box->nro_cajas, 2) ?>
                                                <?php } ?>
                        ...
                        <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <?php if ($item->product_category_id  == 4 || $item->product_category_id  == 5 || $item->product_category_id  == 27 || $item->product_category_id  == 31 || $item->product_category_id  == 10 || $item->product_category_id  == 25) { ?>
                                    ...
                                    <?php if (($item->product_category_id == 31 && ($cliente->cliente_id == 6)) || ($item->product_category_id == 31 && ($cliente->cliente_id == 12))) { ?>
                                        <?php $total = $item->qty_bunches * $item->price * $item->qty ?>
                                    <?php } else { ?>
                                        <?php if ($cliente->cliente_id != 5) { ?>
                                            <?php if ($item->product_category_id == 25) { ?>
                                                <?php $total = $item->qty_bunches * $item->price * $item->qty ?>
                                            <?php } else { ?>
                                                <?php $total =  $item->total_steams * $item->price * $item->qty ?>
                                            <?php } ?>
                                        <?php } else { ?>
                                            <?php $total = $item->qty_bunches * $item->price * $item->qty ?>
                                        <?php } ?>
