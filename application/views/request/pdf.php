...
<body>
	...
	<div style="margin-left: 100px; margin-right: 100px;">
		<div style="width: 355px; height:auto; float: left;">
			<img id="logo_cliente" style="width: 355px; height:100px;" class="img img-rounded img-responsive" src="<?= base_url('assets/nuevo.jpg'); ?>" />
			...
			<table id="tabla" class="table">
				<thead>
					<tr>
						...
						<th style="width:160px; font-size: 18px;">Precio por caja</th>
				...
				<tbody id="cuerpo">
					...
					<?php foreach ($all_request as $item) { ?>
						<tr>
							...
							<td style="font-size: 18px; text-align: center">$<?= number_format($item->unit_price, 3); ?></td>
							<td style="font-size: 18px; text-align: center">$<?= number_format(($item->total_price / $item->box->qty), 2); ?></td>
							<td style="font-size: 18px; text-align: center">$<?= number_format($item->total_price, 2); ?></td>
						</tr>
				...
				<tfoot>
					<tr>
						...
						<td style="width:150px; font-size: 18px; text-align: center;">
							...
							<h3 style="text-align: center" id="totales">$<?= number_format($total, 2); ?></h3>
						</td>
						<td>
