...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('add_variety_provider_lang'); ?></small>
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div id="body_varieties" style="display:none" class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div id="body_measure" style="display:none" class="col-lg-12">
                                        <label><?= translate("measures_lang"); ?></label>
                                        <div id="select_measure" class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-arrows"></i></span>
