...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('update_country_lang'); ?></small>
            | <a href="<?= site_url('country/index'); ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?= translate('back_lang'); ?>
            </a>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= site_url('dashboard/index'); ?>"><i class="fa fa-dashboard"></i> <?= translate('pizarra_resumen_lang'); ?></a></li>
            <li class="active"><?= translate('update_country_lang'); ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('update_country_lang'); ?></h3>
                    </div>
                    <div class="box-body">

                        <?= get_message_from_operation(); ?>
                        <?= form_open_multipart("country/update"); ?>
                        <input type="hidden" name="pais_id" value="<?= $country_object->country_id; ?>" />
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-sm" name="nombre" value="<?= $country_object->name; ?>">
                                        </div>
                                    </div>
