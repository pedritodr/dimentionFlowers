<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <a href="<?= site_url('country/add_index'); ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?= translate('add_item_lang'); ?>
            </a>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach ($allcountrys as $item) { ?>
                                    <tr>
                                        <td><?= $item->name; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('country/delete/' . $item->country_id); ?>" class="btn btn-danger"><i class="fa fa-remove"></i> <?= translate("delete_lang"); ?></a>
