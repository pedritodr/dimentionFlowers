            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <?= form_open_multipart("credito/update_credito_finca"); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="fincas" name="fincas" onchange="cargar_facturas()" class="form-control select2" style="width: 100%;" required>
                                                ...
                                                <?php foreach ($providers as $provider) { ?>
                                                    <option <?php if ($credito_object->provider_id == $provider->provider_id) { ?> selected <?php } ?> value="<?= $provider->provider_id ?>"><?= $provider->name ?></option>
                                                <?php  } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div id="body_valor" class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-sort-numeric-asc"></i></span>
                                            <input type="number" class="form-control input-md" id="valor" name="valor" min="0" step="any" onchange="activar_boton()" pattern="^[0-9]+" placeholder="<?= "Valor" ?>" required value="<?= $credito_object->valor ?>">
                                        </div>
                                    </div>
...
<script>
    $(function() {
        ...
        $('#tallos').val(credito.tallos);
        $('#valor').val(credito.valor);
        $.ajax({
            type: 'POST',
