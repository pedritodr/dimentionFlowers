...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?= translate('add_city_lang'); ?></small>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= translate('add_destino_lang'); ?></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= translate('add_destination_lang'); ?></h3>
                    </div>
                    <div class="box-body">

                        <?= get_message_from_operation(); ?>

                        <?= form_open_multipart("destination/add"); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-sm" name="nombre" placeholder="<?= translate('nombre_lang'); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="pais" name="pais" class="form-control input-sm" data-placeholder="Seleccione una opción" style="width: 100%" required>
