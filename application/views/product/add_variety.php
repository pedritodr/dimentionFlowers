  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <h1>
              ...
              <small><?= translate('add_variety_lang'); ?></small>
              | <a href="<?= site_url('product/variety_index/' . $product_id); ?>" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> <?= translate('back_lang'); ?>
              </a>
          </h1>
          <ol class="breadcrumb">
              <li><a href="<?= site_url('dashboard/index'); ?>"><i class="fa fa-dashboard"></i> <?= translate('pizarra_resumen_lang'); ?></a></li>
              <li class="active"><?= translate('add_variety_lang'); ?></li>
              ...
              <div class="col-xs-12">
                  ...
                  <div class="box box-default">
                      <div class="box-header with-border">
                          <h3 class="box-title"><?= translate('add_variety_lang'); ?></h3>
                      </div>
                      <div class="box-body">

                          <?= get_message_from_operation(); ?>

                          <?= form_open_multipart("product/add_variety"); ?>
