...
class Empresa extends CI_Controller
{
    ...
    public function update()
    {
        ...
        $phone_us = $this->input->post('telef_usa');
        $mobile = $this->input->post('mobile');
        $secuencial_po = $this->input->post('secuencial_po');
        $city_country = $this->input->post('city_country');
        $secuencial_carguera = $this->input->post('secuencial_carguera');
        $referendum = $this->input->post('referendum');
        ...
        if ($this->form_validation->run() == FALSE) { //si alguna de las reglas de validacion fallaron
            ...
            if ($empresa_object) {
                $data = [
                    ...
                    'email_contact' => $email,
                    'email_contact2' => $email2,
                    'facebook' => $facebook,
                    'instagram' => $instagram,
                    'youtube' => $youtube,
                    'video' => $url_video,
                    'secuencial_po' => $secuencial_po,
                    'secuencial_carguera' => $secuencial_carguera,
