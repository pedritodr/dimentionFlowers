...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-07-2019 a las 05:25:29
...
INSERT INTO `pending` (`pending_id`, `request_id`, `qty`, `provider_id`) VALUES
(5, 1, 2, 1),
(6, 1, 1, 1);
...
(1, '2019-10-30', 8, 2, '2019-10-27', 'PO20188901');
...
--
ALTER TABLE `buy`
  MODIFY `buy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `buy_element`
--
ALTER TABLE `buy_element`
  MODIFY `buy_element_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `invoice_provider`
  MODIFY `invoce_provider_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
