...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2019 a las 03:03:13
...
(7, 'pedro duran', 'cmdelgador@gmail.com', 11, 1, 'av principal', 'pablo duran', '4264505884', './uploads/cliente/1560184820.png', 'pedroduran014@gmail.com', 'pablo duran', 'pedroduran014@gmail.com');
...
INSERT INTO `dialing` (`dialing_id`, `name`, `code`, `destination_id`, `cliente_id`) VALUES
(7, 'profesorPrueba', '9789978495797', 1, 6),
(8, 'prueba', '9789978494875', 2, 6),
(9, 'pruebita', '9789978495797', 4, 6);
...
INSERT INTO `provider` (`provider_id`, `name`, `tax_id`, `email`, `phone`, `email_seller`, `person_payment`, `data_banking`, `data_additional`) VALUES
...
(3, 'finca2', '2finca6564', 'pedroduran014@gmail.com', '4264505884', 'pedroduran014@gmail.com', 'julio jaramillo', '<p>hola</p>', '<p>hhola</p>');
...
(11, 'pedro duran', 'pedroduran014@hotmail.com', '4983a0ab83ed86e0e7213c8783940193', 3);
...
(4, 'variedad 1', '10cm', './uploads/variety/1560191328.jpg', 5, '<p>es de 10 cm</p>', 1),
(5, 'varierdad2', '50cm', './uploads/variety/1560210245.jpg', 5, '<p>varierdad2<br></p>', 0);
...
--
ALTER TABLE `dialing`
  MODIFY `dialing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `provider_variety`
  MODIFY `provider_variety_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `variety`
  MODIFY `variety_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
