...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2019 a las 18:57:42
...
(46, 1, 20, 3, 42, 51, '2019-07-05'),
(47, 1, 54, 3, 42, 51, '2019-07-05'),
(48, 5, 24, 1, 42, 52, '2019-07-05'),
(49, 2, 24, 3, 42, 52, '2019-07-05'),
(50, 7, 41, 2, 42, 52, '2019-07-05');
...
--
ALTER TABLE `buy`
  MODIFY `buy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT de la tabla `buy_element`
--
ALTER TABLE `buy_element`
  MODIFY `buy_element_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `request_variety`
  MODIFY `request_variety_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT de la tabla `request_variety_box`
--
ALTER TABLE `request_variety_box`
  MODIFY `request_variety_box_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
