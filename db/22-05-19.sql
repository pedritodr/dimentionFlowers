...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2019 a las 23:53:45
...
INSERT INTO `cliente` (`cliente_id`, `cliente_name`, `identificador`, `user_id`, `user_vendedor_id`) VALUES
(2, 'Almacenes de rosas don Mario', '123-cliente', 5, 1);
...
(2, 'clavel de manana', '<p>este es una clavel de manana</p>', './uploads/product/1558551344.jpg', 12.5, 1, 2),
(3, 'Orquideas venezolana', '<p>esta es una Orquideas venezolana</p>', './uploads/product/1558551334.jpg', 15, 2, 2);
...
--
-- Volcado de datos para la tabla `subport`
--

INSERT INTO `subport` (`subport_id`, `name`, `code`, `destination_id`) VALUES
(1, 'mantita', '01-mantita', 1);
...
(5, 'Almacenes de rosas don Mario', 'cliente1@gmail.com', '4983a0ab83ed86e0e7213c8783940193', 3);
...
--
ALTER TABLE `box_type`
  MODIFY `box_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `subport`
  MODIFY `subport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
