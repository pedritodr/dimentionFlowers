...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2019 a las 02:56:22
...
INSERT INTO `buy` (`buy_id`, `date`, `request_id`, `user_id`) VALUES
(22, '2019-06-25', 58, 1),
(23, '2019-06-25', 58, 1),
(24, '2019-06-25', 57, 1),
(25, '2019-06-25', 57, 1),
...
INSERT INTO `buy_element` (`buy_element_id`, `qty`, `price`, `provider_id`, `buy_id`, `request_variety_id`) VALUES
(14, 3, 32, 3, 22, 36),
(15, 2, 12, 3, 23, 35),
(16, 1, 12, 1, 24, 34),
(17, 2, 12, 3, 25, 32),
...
(2, 'Rose color high & yellow', '<p><u></u>Rose color 50cm high & yellow </p>', './uploads/product/1558551344.jpg', 1, 1),
(3, 'Rose color  high & red', '<p>Rose color 50cm high & red<br></p>', './uploads/product/1558551334.jpg', 2, 1),
(5, 'ROSE COLOR RAINBOW', '<p>esta es una rosa natural</p>', './uploads/product/1558629184.jpg', 3, 1),
(6, 'Rose color high & blue', '<p>Rose color 50cm high & blue<br></p>', './uploads/product/1559234370.jpg', 3, 1),
(7, 'ROSE COLOR HIGT & YELLOW', '<p>esta es una etiqueta</p>', './uploads/product/1560351045.jpg', 3, 1);
...
(57, '2019-04-30', 8, 0, '2019-04-23', 'PO793853'),
(58, '2019-04-12', 8, 0, '2019-04-12', 'PO20188901');
...
INSERT INTO `request_variety` (`request_variety_id`, `variety_id`, `request_id`, `dialing_id`, `unit`, `unit_price`, `total_price`, `status`) VALUES
(32, 13, 57, 12, 150, 42, 84, 1),
(33, 11, 57, 12, 156, 43.68, 393.12, 1),
(34, 4, 57, 12, 150, 45, 45, 1),
(35, 13, 58, 12, 150, 42, 84, 1),
(36, 10, 58, 12, 150, 42, 126, 1);
...
(24, 'Rose color high & blue ', './uploads/variety/1561509141.jpg', 3, '<p>\r\n\r\n</p><div><div>Rose color high & blue </div></div>\r\n\r\n<br><p></p>', 1);
...
--
ALTER TABLE `buy`
  MODIFY `buy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT de la tabla `buy_element`
--
ALTER TABLE `buy_element`
  MODIFY `buy_element_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `provider_variety`
  MODIFY `provider_variety_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `request_variety`
  MODIFY `request_variety_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT de la tabla `request_variety_box`
--
ALTER TABLE `request_variety_box`
  MODIFY `request_variety_box_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `variety`
  MODIFY `variety_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `variety_measure`
--
ALTER TABLE `variety_measure`
  MODIFY `variety_measure_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
