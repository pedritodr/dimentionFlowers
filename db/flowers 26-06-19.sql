...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2019 a las 20:15:44
...
(3, 'Rose color  high & red', '<p>Rose color 50cm high & red<br></p>', './uploads/product/1558551334.jpg', 2, 1, 12),
...
--
ALTER TABLE `variety_measure`
  MODIFY `variety_measure_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
COMMIT;
